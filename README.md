...
<head>
    ...
    <style>
        /* Custom styles for Arshad Kirana Store */
        .hero-bg {
        ...
        /* Ensure Hero section has enough height for vertical alignment */
        #home {
            min-height: 80vh; /* Full viewport height minus navbar */
            display: flex;
            flex-direction: column;
        }
        /* Ensure Services section has enough height for vertical alignment */
        #services {
            min-height: 80vh;
            display: flex;
            flex-direction: column;
...
<body class="font-body text-gray-800 bg-white">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="bg-gray-100 p-6 rounded-lg shadow-lg flex items-start">
                    <img src="https://images.unsplash.com/photo-1607349913338-fca6f7fc42d0?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80" alt="Ravi" class="w-12 h-12 rounded-full mr-4">
                    <div>
                ...
                <div class="bg-gray-100 p-6 rounded-lg shadow-lg flex items-start">
                    <img src="https://images.unsplash.com/photo-1599834562135-b6fc90e642ca?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80" alt="Md Sarik" class="w-12 h-12 rounded-full mr-4">
                    <div>
    ...
    <section id="home" class="hero-bg text-white pt-24 pb-20">
        <div class="max-w-7xl ml-0 px-4 sm:px-6 lg:px-8 flex flex-col justify-end h-full">
            <h1 class="text-4xl md:text-5xl font-heading font-extrabold mb-4 text-left">Welcome to Arshad Kirana Store</h1>
            <p class="text-lg md:text-xl mb-8 max-w-2xl text-left">Your one-stop shop for quality groceries and essentials. Start shopping today!</p>
            <a href="#contact" class="inline-block bg-white text-red-500 font-semibold py-3 px-6 rounded-full hover:bg-gray-100 transition self-start">Get Started</a>
        </div>
    </section>
    ...
    <section id="services" class="py-20 bg-gray-100">
        <div class="max-w-7xl ml-0 px-4 sm:px-6 lg:px-8 flex flex-col justify-end h-full">
            <h2 class="text-3xl font-heading font-bold mb-12 text-left">Our Services</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white p-6 rounded-lg shadow-lg text-left">
                    <img src="https://template.canva.com/EAFbCS-9WbQ/2/0/1600w-5HPNn8Zx6oU.jpg" alt="Quality Products" class="w-16 h-16 mb-4 service-img" onerror="this.src='https://via.placeholder.com/64?text=Quality'">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg text-left">
                    <img src="https://i.imgur.com/WMW8Bts.png" alt="Fast Delivery" class="w-16 h-16 mb-4 service-img" onerror="this.src='https://via.placeholder.com/64?text=Delivery'">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg text-left">
                    <img src="https://i.imgur.com/J8efyOS.jpeg" alt="Customer Support" class="w-16 h-16 mb-4 service-img" onerror="this.src='https://via.placeholder.com/64?text=Support'">
    ...
    <script>
        ...
        document.querySelectorAll('a[href^="#"]').forEach(anchor => {
            anchor.addEventListener('click', function (e) {
                ...
                if (targetElement) {
                    window.scrollTo({
                        top: targetElement.offsetTop - 64, // Adjust for fixed navbar height
                        behavior: 'smooth'
                    });
                }
            });
